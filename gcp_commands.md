...
gcloud iam service-accounts create terraform-cloud \
 ...
 gcloud projects add-iam-policy-binding advancedterraform-472203 \
    --member="serviceAccount:terraform-cloud@advancedterraform-472203.iam.gserviceaccount.com" \
    --role="roles/owner"

gcloud iam service-accounts keys create tf_sa_key \
    --iam-account=terraform-cloud@advancedterraform-472203.iam.gserviceaccount.com
```